    ...
    return (
        <div className="App">
            ...
            <Modal
                ...
                <Form {...layout}>
                    <Item label="Placa">
                        <Input name="registration" onChange={handleChange} value={service && service.registration} placeholder="0000-AAA"/>
                    </Item>
                    <Item label="Nome">
                    ...
                    <Item label="Data">
                    <Input name="date" onChange={handleChange} placeholder="00/00/0000"/>
                    </Item>
                    <Item label="Hora">
                        <Input name="hour" onChange={handleChange} placeholder="00:00"/>
                    </Item>
                    <Item label="Descrição">
                        <Input name="description" onChange={handleChange} placeholder="Texto" />
                    </Item>
                </Form>
            </Modal>
